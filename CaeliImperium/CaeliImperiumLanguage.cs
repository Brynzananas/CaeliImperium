...
namespace CaeliImperium
{
    public static class CaeliImperiumLanguage
    {
        ...
        public static void InitPipelineRefinery()
        {
            ...
            AddLanguageToken("CI_REFINERY_OBJECTIVE_READY", humanObjectivePrefix + "On Site Refinery" + endPrefix + " is ready to start");
            ...
            AddLanguageToken("CI_REFINERY_DESC", "Gambit equipment to extract planets valuable materials. Call extractors onto resource wells, build and connect pipelines to extractors, start refinery, repair pipes and claim your item reward.");
            ...
            AddLanguageToken("CI_PIPELINE_CANCEL_CONTEXT", "Cancel Building");
            AddLanguageToken("CI_PIPELINE_CANCEL_CONTEXT", "Отменить Строение", "ru");
